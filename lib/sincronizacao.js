...
export function vencimentoDaCompetencia(competencia, dia, dataInicio = null) {
  const mesCompetencia = String(competencia || "").slice(0, 7);
  const mesInicio = String(dataInicio || "").slice(0, 7);

  // Aluguel antecipado: a primeira mensalidade vence no dia da entrada.
  if (dataInicio && mesInicio === mesCompetencia) {
